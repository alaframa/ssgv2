...
const NAV = [
  ...
  {
    href: "/orders", label: "Purchase Order",
  ...
  {
    href: "/delivery", label: "Delivery Order",
  ...
  },
  {
    ...
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="4"/><path d="M6 20v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><line x1="19" y1="8" x2="23" y2="8"/><line x1="21" y1="6" x2="21" y2="10"/></svg>,
  },
];
...
export default function Sidebar({ user }: SidebarProps) {
  ...
  const items = NAV.filter((n) => !(n as any).adminOnly || user.role === "SUPER_ADMIN");

  return (
    <aside style={{ width: 256, minWidth: 256 }}
          ...
          return (
            <Link key={item.href} href={item.href}
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium
                transition-colors duration-100 ${active
